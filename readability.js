...
/*
      const dom = new JSDOM(``, {
  url: meta.request.uri.href,
  referrer: meta.request.uri.href,
...
module.exports.read = function() {
  //console.warn('`readabiliddty.read` is deprecated. Just use `var read = require("node-readability"); read(url...);`.');
